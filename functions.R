...
match_mc5=function(id){
  ...
  ifelse(flag[1],0,sum(m_c5id[i[1]:j[1],1]))+
    ifelse(flag[2],0,sum(m_c5id[i[2]:j[2],2]))+
    ifelse(flag[3],0,sum(m_c5id[i[3]:j[3],3]))+
    ifelse(flag[4],0,sum(m_c5id[i[4]:j[4],4]))+
    ifelse(flag[5],0,sum(m_c5id[i[5]:j[5],5]))+1
}
