...
seq5in7=function(hd2,bd5){
  ...
  m413[]=0L; m413[v_7]=1L# 将v_7在m413中的位置置为1
...
# 5: 4（20180217——unused.R里）的非注释版，较1快12.35%((3.24-2.84)/3.24)------------
# 以上1-4都有代码错误，这段经过验证 ------------------------------------------------------
p_st=rep(1:4,13)
  ...
  if(l_sq>4){
    ...
    if(l_sq==6){
      if(m_st[max_st]==5) v_5=v_7[v_7st==max_st]
        ...
        v_5=v_7[v_7st==max_st]
        if((v_5[1]+16)==v_5[5]) v_5=v_5[1:5]
        else if((v_5[2]+16)==v_5[6]) v_5=v_5[2:6]
        else if((v_5[1]+36)==v_5[3]) v_5=v_5[c(1,3:6)]
        else v_5=v_5[1:5]
      } else{
      ...
      if(m_st[max_st]==5) v_5=v_7[v_7st==max_st]
        ...
        else if((v_5[3]+16)==v_5[7]) v_5=v_5[3:7]
        else if((v_5[1]+36)==v_5[4]) v_5=v_5[c(1,4:7)]
        else v_5=v_5[1:5]
      } else{
        if((m_sq[1]+4)==m_sq[5]) v_5=v_7[cumsum(m_fc[m_sq])][1:5]
        else if((m_sq[2]+4)==m_sq[6]) v_5=v_7[cumsum(m_fc[m_sq])][2:6]
